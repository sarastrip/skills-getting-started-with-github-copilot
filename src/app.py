...
activities = {
    ...
    "Swim Club": {
        "description": "Competitive and recreational swim sessions for all levels",
        "schedule": "Mondays, Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["lily@mergington.edu", "noah@mergington.edu"]
    },
    "Art Studio": {
        "description": "Explore painting, drawing, and mixed media in a relaxed studio setting",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["isabella@mergington.edu", "jack@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting, stagecraft, and theater production for creative students",
